...
exports.createOrder = async (req, res) => {
  try {
    ...
    const hasPickup =
      pickupDetails &&
      typeof pickupDetails.location === "string" &&
      pickupDetails.location.trim() !== "";
    ...
    if (!hasPickup && !hasDeliveryAddress) {
      return res.status(400).json({
        success: false,
        message:
          "Please provide either pickup location or complete delivery address",
      });
    }
