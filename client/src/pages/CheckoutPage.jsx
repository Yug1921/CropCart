  ...
  const handleSubmitOrder = (e) => {
    ...
    if (orderType === "pickup") {
      orderData.pickupDetails = {
        ...
        location: orderDetails.pickupDetails.location.trim(),
      };
    } else {
      orderData.deliveryDetails = {
        ...
        address: {
          ...
          street: orderDetails.deliveryDetails.address.street.trim(),
          city: orderDetails.deliveryDetails.address.city.trim(),
          state: orderDetails.deliveryDetails.address.state.trim(),
          zipCode: orderDetails.deliveryDetails.address.zipCode.trim(),
        },
      };
    }
            ...
            <form onSubmit={handleSubmitOrder}>
              ...
              <div className="mt-4">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Online gateway is not integrated yet. Choose your preferred
