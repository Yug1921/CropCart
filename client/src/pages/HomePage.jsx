...
const HomePage = () => {
  ...
  return (
    <div>
        ...
        <div className="relative z-10 w-full">
          <div className="max-w-2xl mx-auto text-center px-4">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold mb-6 text-gray-900">
              Fresh Produce, Fewer Layers.
              <br className="hidden md:block" /> Meet Farmers Directly.
            </h1>
            <p className="text-base md:text-lg text-gray-600 mb-10">
              CropCart brings the farm to your screen with transparent pricing,
              trusted growers, and easy ordering.
              <br className="hidden md:block" />
              Eat seasonal, support local, and shop with confidence.
            </p>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            ...
            <Link
              to="/products"
              className="text-amber-700 hover:text-amber-900 font-medium text-lg transition-all duration-300"
            >
              View All Products →
            </Link>
          </div>
      ...
      <section className="py-24 bg-gradient-to-r from-amber-700 to-stone-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link
              to="/register"
              className="btn bg-white text-amber-800 hover:bg-gray-100 px-8 py-3 rounded-lg font-bold text-lg"
            >
              Sign Up Now
            </Link>
            <Link
              to="/about"
              className="btn border-2 border-white text-white hover:bg-white hover:text-amber-800 px-8 py-3 rounded-lg font-bold text-lg"
            >
              Learn More
            </Link>
          </div>
